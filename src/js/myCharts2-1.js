                        ...
                        tooltip: {
                          ...
                          external: function(tooltipModel) {
                            //console.log('tooltipModel:', tooltipModel);
                              ...
                              //  console.log(this.x*1+400,this._chart.width,'<<tooltipModel::',tooltipModel);
                                if (this.x*1+400 >this._chart.width){
                                tooltipModel.tooltip.x = this.x-400;
                                }
                            ...
                            callbacks: {
                              ...
                              //context.element.$context.element.active=true;
                              ...
                              //{value:context.raw,year:context.dataset.label,monthNo:context.dataIndex,month:context.element.label}
                                  ...
                                  //return returnDataExt(context.raw, context.dataset.label, context.dataIndex);
                                }
                            }
                        }
                      }
